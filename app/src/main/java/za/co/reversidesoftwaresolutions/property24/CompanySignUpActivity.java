    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentLogin = new Intent(CompanySignUpActivity.this, LoginActivity.class);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name)) {
                    Toast.makeText(getApplicationContext(), "Company name field cannot be empty!", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (TextUtils.isEmpty(phone)) {
                    Toast.makeText(getApplicationContext(), "Company phone field cannot be empty!", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (TextUtils.isEmpty(password)) {
                    Toast.makeText(getApplicationContext(), "Company password field cannot be empty!", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplicationContext(), "Company email field cannot be empty!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mFirebaseAuth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(CompanySignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(CompanySignUpActivity.this, "A new company account created" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                mProgressBar.setVisibility(View.VISIBLE);
                                ...
                                if (!task.isSuccessful()) {
                                    Toast.makeText(CompanySignUpActivity.this, "Company Authentication failed." + task.getException(),
